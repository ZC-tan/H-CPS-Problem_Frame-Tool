 ...
 * </p>
 * <ul>
 *   <li>{@link UML.impl.ValueSpecificationImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueSpecificationImpl extends MinimalEObjectImpl.Container implements ValueSpecification {
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VALUE_SPECIFICATION__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UMLPackage.VALUE_SPECIFICATION__BODY:
			return getBody();
		}
