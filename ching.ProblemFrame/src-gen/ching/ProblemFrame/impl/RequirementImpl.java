 ...
 * </p>
 * <ul>
 *   <li>{@link ching.ProblemFrame.impl.RequirementImpl#getName <em>Name</em>}</li>
 *   <li>{@link ching.ProblemFrame.impl.RequirementImpl#getStatemachine <em>Statemachine</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementImpl extends MinimalEObjectImpl.Container implements Requirement {
	...
	protected EClass eStaticClass() {
		return ProblemFramePackage.Literals.REQUIREMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProblemFramePackage.REQUIREMENT__NAME, oldName,
					name));
	}
	...
	public EList<MyStateMachine> getStatemachine() {
		if (statemachine == null) {
			statemachine = new EObjectContainmentEList<MyStateMachine>(MyStateMachine.class, this,
					ProblemFramePackage.REQUIREMENT__STATEMACHINE);
		}
		return statemachine;
	}
