 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.statemachine.model.UML.impl.ValueSpecificationImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueSpecificationImpl extends MinimalEObjectImpl.Container implements ValueSpecification {
	...
	protected EClass eStaticClass() {
		return StatemachinePackage.Literals.VALUE_SPECIFICATION;
	}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatemachinePackage.VALUE_SPECIFICATION__BODY,
					oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case StatemachinePackage.VALUE_SPECIFICATION__BODY:
			return getBody();
		}
