...
public class PseudostateItemProvider extends VertexItemProvider {
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Pseudostate_kind_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Pseudostate_kind_feature",
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Pseudostate_type")
