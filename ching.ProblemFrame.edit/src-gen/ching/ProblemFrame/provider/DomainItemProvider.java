...
/**
 * This is the item provider adapter for a {@link ching.ProblemFrame.Domain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ProblemFramePackage.Literals.DOMAIN__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Domain_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Domain_type_feature", "_UI_Domain_type"),
						ProblemFramePackage.Literals.DOMAIN__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProblemFramePackage.Literals.DOMAIN__PHENOMENA);
			childrenFeatures.add(ProblemFramePackage.Literals.DOMAIN__STATEMACHINE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ProblemFramePackage.Literals.DOMAIN__PHENOMENA,
				ProblemFrameFactory.eINSTANCE.createPhenomenon()));

		newChildDescriptors.add(createChildParameter(ProblemFramePackage.Literals.DOMAIN__STATEMACHINE,
