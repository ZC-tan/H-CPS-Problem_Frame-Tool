 ...
 * </p>
 * <ul>
 *   <li>{@link UML.impl.MachineToHumanRelationImpl#getMachineSource <em>Machine Source</em>}</li>
 *   <li>{@link UML.impl.MachineToHumanRelationImpl#getHumanTarget <em>Human Target</em>}</li>
 *   <li>{@link UML.impl.MachineToHumanRelationImpl#getRelationName <em>Relation Name</em>}</li>
 *   <li>{@link UML.impl.MachineToHumanRelationImpl#getInterfaceName <em>Interface Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MachineToHumanRelationImpl extends MinimalEObjectImpl.Container implements MachineToHumanRelation {
	...
	protected EClass eStaticClass() {
		return UMLPackage.Literals.MACHINE_TO_HUMAN_RELATION;
	}
			...
			if (machineSource != oldMachineSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							UMLPackage.MACHINE_TO_HUMAN_RELATION__MACHINE_SOURCE, oldMachineSource, machineSource));
			}
		}
	...
	public void setMachineSource(Machine newMachineSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MACHINE_TO_HUMAN_RELATION__MACHINE_SOURCE,
					oldMachineSource, machineSource));
	}
	...
	public Human getHumanTarget() {
		if (humanTarget != null && humanTarget.eIsProxy()) {
			...
			if (humanTarget != oldHumanTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							UMLPackage.MACHINE_TO_HUMAN_RELATION__HUMAN_TARGET, oldHumanTarget, humanTarget));
			}
		}
		return humanTarget;
	}
	...
	public void setHumanTarget(Human newHumanTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MACHINE_TO_HUMAN_RELATION__HUMAN_TARGET,
					oldHumanTarget, humanTarget));
	}
	...
	public void setRelationName(String newRelationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MACHINE_TO_HUMAN_RELATION__RELATION_NAME,
	...
	public void setInterfaceName(String newInterfaceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MACHINE_TO_HUMAN_RELATION__INTERFACE_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UMLPackage.MACHINE_TO_HUMAN_RELATION__MACHINE_SOURCE:
			if (resolve)
				return getMachineSource();
			return basicGetMachineSource();
		case UMLPackage.MACHINE_TO_HUMAN_RELATION__HUMAN_TARGET:
			if (resolve)
