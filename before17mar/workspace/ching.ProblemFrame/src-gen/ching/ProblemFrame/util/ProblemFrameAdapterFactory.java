...
public class ProblemFrameAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProblemFrameSwitch<Adapter> modelSwitch = new ProblemFrameSwitch<Adapter>() {
		...
		@Override
		public Adapter caseBiddableDomain(BiddableDomain object) {
			return createBiddableDomainAdapter();
		}

		@Override
		public Adapter caseCausalDomain(CausalDomain object) {
			return createCausalDomainAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link ching.ProblemFrame.BiddableDomain <em>Biddable Domain</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ching.ProblemFrame.CausalDomain <em>Causal Domain</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
