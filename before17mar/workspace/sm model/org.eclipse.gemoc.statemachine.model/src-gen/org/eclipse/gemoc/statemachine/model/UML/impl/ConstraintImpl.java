 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.statemachine.model.UML.impl.ConstraintImpl#getSpecification <em>Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintImpl extends NamedElementImpl implements Constraint {
	...
	public NotificationChain basicSetSpecification(ValueSpecification newSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StatemachinePackage.CONSTRAINT__SPECIFICATION, oldSpecification, newSpecification);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSpecification != specification) {
			...
			if (specification != null)
				msgs = ((InternalEObject) specification).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StatemachinePackage.CONSTRAINT__SPECIFICATION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StatemachinePackage.CONSTRAINT__SPECIFICATION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case StatemachinePackage.CONSTRAINT__SPECIFICATION:
